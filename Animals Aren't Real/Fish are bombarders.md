...
[VISUAL]
Use several syncronized Split Screens, horizontal and diagonal. 
Use Deep Of Field to create Epic AMbiance
...
[SEGMENTS]
9 segments with 2 scenes each of live-action video based from the reference mechanical fish in the uploaded image; 
start anchor-reference image at 0.00s already in movement; following segments MUST be < 2.0 s each; 
cut to dark at 24.8 s; end clean.

[MAIN IDEA]
The mechanical fish are actually the ultimate steampunk war machine: submarine and airplane bomber; We can see the mechanisms that makes the fish work, and possible a demonstration of their war/bombing capabilities.
...
FX is loud, 
SFX is epic.
No voice over, only a 135-145 BPM PHONK and OMINOUS dark-electro midtempo
